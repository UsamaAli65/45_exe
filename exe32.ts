...
const currentUsers: string[] = ['ali', 'Jane', 'muhammad ali', 'Ali E', 'usama'];

// Make a list of new users
const newUsers: string[] = ['maham', 'sadiq', 'Ahmed', 'zaka', 'waqas'];

// Loop through new_users list
for (let newUser of newUsers) {
    // Check if the new username is already in use (case-insensitive)
    const isUsernameTaken = currentUsers.some((username) => username.toLowerCase() === newUser.toLowerCase());
